...
| user_id | int | - | NO | - | [users.id](./users.md) | ID of the user who placed the order |
| coupon_id | int | - | YES | - | [coupons.id](./coupons.md) | Optional coupon applied to this order (nullable foreign key) |
| total_cents | int | - | NO | - | - | Total order amount in cents |

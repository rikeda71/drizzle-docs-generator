...
|------|------|---------|----------|----------|---------|---------|
| **id** | integer | - | NO | [comments.post_id](#comments), [post_tags.post_id](#post-tags) | - | Auto-generated unique identifier |
| title | text | - | NO | - | - | Post title |
| content | text | - | YES | - | - | Post content body |
| published | integer | `false` | YES | - | - | Whether the post is published |
| author_id | integer | - | NO | - | [users.id](#users) | ID of the post author |
